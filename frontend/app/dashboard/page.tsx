    ...
    try {
      ...
      try {
        const response = await fetch('https://eh5scbzco7.execute-api.us-east-1.amazonaws.com/prod/recommend', {
          ...
          body: JSON.stringify({
            itinerary_landmarks: locations.map(loc => loc.name),
            vision_description: `Popular tourist attractions and landmarks near ${destination}`,
            clip_embedding: null,
                      ...
                      <div className="px-5 py-4">
                        ...
                        <div className="grid grid-cols-2 gap-2 mb-3">
                          <button
                            ...
                            className={`relative bg-zinc-800 bg-opacity-40 backdrop-blur-sm text-stone-300 px-3 py-2 rounded-xl text-sm font-medium flex items-center justify-center gap-2 overflow-hidden cursor-default ${
                              loadingRecommendations 
                                ? '' 
                                : 'border border-orange-500 border-opacity-50 hover:bg-orange-600 hover:text-white hover:border-opacity-100 transition-colors'
                            }`}
                            style={loadingRecommendations ? {
                              background: 'linear-gradient(90deg, #ea580c, #f97316, #fb923c, #fdba74, #fb923c, #f97316, #ea580c)',
                          ...
                          >
                            {loadingRecommendations ? (
                              <div className="w-full h-full bg-zinc-800 bg-opacity-40 backdrop-blur-sm rounded-[10px] px-3 py-2 flex items-center justify-center gap-2">
                          ...
                          <button
                            ...
                            className="bg-zinc-800 bg-opacity-40 backdrop-blur-sm border border-orange-500 border-opacity-50 text-stone-300 px-3 py-2 rounded-xl text-sm font-medium cursor-pointer flex items-center justify-center gap-2 hover:bg-orange-600 hover:text-white hover:border-opacity-100 transition-all"
                          >
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
